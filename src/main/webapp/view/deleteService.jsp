...
<title>Delete Vendor Service</title>
...
<h1>On Demand Car Wash</h1>
	...
	<div id="form_section">
		<h3>Delete Vendor Service</h3>
		<h5 style="color:red">${error }</h5>
		<sf:form action="deletefromdatabase" method="post" modelAttribute="vendor">
				...
				<div class="form-group">
					...
					<sf:input class="form-control" path="wcName" type="text" required="required"/>
