...
<h1>On Demand Car Wash</h1>
	...
	<form action="uLogin2" method="get">
		<div class="form-group">
			<label for="uName" class="form-check-label">Email</label>
			<input type="text" placeholder="Enter your Email address" id="uName" name="uName" class="form-control" required="required"/>
		</div>
		<div class="form-group">	 
			<label for="uPassword" class="form-check-label">Password</label>
			<input type="password" placeholder="Enter your password" name="uPassword" class="form-control" required="required"/>
		</div>
